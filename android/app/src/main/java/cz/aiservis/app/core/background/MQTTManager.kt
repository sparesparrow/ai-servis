...
import cz.aiservis.app.core.networking.MdnsDiscovery
...
class MQTTManagerImpl @Inject constructor(
	...
	private val envBrokerUrl: String? = System.getenv("AI_SERVIS_MQTT_URL")
	private val defaultBrokerUrl: String = "tcp://test.mosquitto.org:1883"
	private val clientId: String = "ai-servis-android-" + android.os.Build.SERIAL
